...
print_step_header "3" "Pull Riva Container"
...
complete_script_success "041" "RIVA_ENVIRONMENT_READY" "./scripts/riva-042-download-models.sh"
...
echo "   1. Run: ./scripts/riva-042-download-models.sh"
echo "   2. Run: ./scripts/riva-043-deploy-models.sh" 
echo "   3. Run: ./scripts/riva-044-start-riva-server.sh"
echo ""