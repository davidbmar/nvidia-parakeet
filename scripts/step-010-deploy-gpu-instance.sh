...
echo ""
echo -e "${RED}IMPORTANT - Run this first for secure S3 access:${NC}"
echo "1. Run: ./scripts/step-015-setup-s3-access-iam-role.sh"
echo "   ${BLUE}(Sets up IAM role so instance can access S3 without storing credentials)${NC}"
echo ""
echo "Then choose ONE deployment method:"
echo ""
...
echo "2. Run: ./scripts/step-025-deploy-rnnt-docker.sh"
echo "3. Run: ./scripts/step-030-test-system.sh"
echo ""
echo -e "${GREEN}For WebSocket streaming support (optional):${NC}"
echo "4. Run: ./scripts/step-026-deploy-websocket.sh"
echo ""
